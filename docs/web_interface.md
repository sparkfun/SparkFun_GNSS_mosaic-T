...
-   Currently, at the time that this board was released, the firmware for the mosaic-T module was *v4.15.0*[^4]. Users can download [**version 4.15.0**](./assets/component_documentation/firmware/mosaic-T_fwp_4.15.0.zip) of the firmware, by clicking on the button below.
	...
	<article style="text-align: center;" markdown>
	[:octicons-download-16:{ .heart } Download Firmware *(v4.15.0)*](./assets/component_documentation/firmware/mosaic-T_fwp_4.15.0.zip){ .md-button .md-button--primary target="blank" }
	</article>
